        ...
        <div className="container-custom py-20 md:py-32 relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animate-delay-400">
              <Link
                href="/contact"
                className="bg-[#D4A821] text-primary px-8 py-4 rounded-md font-semibold text-lg hover:bg-[#E5B832] transition-colors text-center"
              >
                Contact Us Today
              </Link>
              <Link
        ...
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              ...
              className="bg-[#D4A821] text-primary px-8 py-4 rounded-md font-semibold text-lg hover:bg-[#E5B832] transition-colors inline-flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
